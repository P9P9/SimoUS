...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/fb65dfda20146477c0f6b.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/fb65dfda20146477c0f6b.jpg"
...
async def iq(iqthonevent):
    ...
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/fb65dfda20146477c0f6b.jpg"
...
async def variable(var):
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await ics.edit("**⌔ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت سورس سيمو يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
...
async def inlineiqthon(iqthon):
    ...
    **⊱━━━━━━━━⊰✾⊱━━━━━━━━⊰
    ⒀ ⦙  `.استخدامي` **✐ :   يضهر لك كمية استخدامك سورس سيمو❝
...
async def inlineiqthon(iqthon):
    ...
    **⑾  ⦙ `.تحويل ملصق دائري + الرد ع الملصق`**✐ :  يحول الملصق الى ملصق دائري** 
    """
    buttons = [[Button.inline("اوامر تحويل الترجمه  ", data="shag2"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)
...
〖`.م9`〗⏎ اوامر الالعاب 3
 ⊱━━━━━━━━⊰✾⊱━━━━━━━━⊰
〖`.م10`〗⏎  اوامر بصمات ميمز 1
〖`.م11`〗⏎  اوامر بصمات ميمز 2
〖`.م12`〗⏎  اوامر بصمات ميمز 3
 ⊱━━━━━━━━⊰✾⊱━━━━━━━━⊰
〖`.م13`〗 ⏎  اوامر الترجمه والتكرار
〖`.م14`〗 ⏎  اوامر الفارات                                             
〖`.م15`〗 ⏎  اوامر الاعلانات و الوقتي
 ⊱━━━━━━━━⊰✾⊱━━━━━━━━⊰
〖`.م16`〗 ⏎  اوامر السورس و الملصقات
〖`.م17`〗 ⏎  اوامر التسليه المتحركه                                               
〖`.م18`〗⏎  اوامر التنزيلات والوسائط                                                                                     
 ⊱━━━━━━━━⊰✾⊱━━━━━━━━⊰
〖`.م19`〗⏎  اوامر الصيغ                   
〖`.م20`〗⏎  اوامر الزخرفة                                 
 ⊱━━━━━━━━⊰✾⊱━━━━━━━━⊰                                    
